...
(defgroup lim nil "Lim it"
  :group 'convenience)

(defface lim-over-limit '((t  :foreground "red" :weight normal :overline t))
  "Lim it character limit face"
  :group 'lim)
(defface lim-info  '((t  :foreground "green" :weight bold :overline nil))
  "Lim it character limit face"
  :group 'lim)
(defface lim-info-over  '((t  :foreground "red" :weight bold :overline t))
  "Lim it character limit face"
  :group 'lim)

(defvar lim-update-info-function 'lim-update-header-line
  "Function for displaying info.")

(defvar lim-after-commands '(narrow-to-region
                             org-narrow-to-subtree
                             org-toggle-narrow-to-subtree
                             org-cycle-level
                             widen)
  "List of commands to re-apply `lim-over-limit' face after.")
